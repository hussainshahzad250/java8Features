...
public class FindMaxAndMinMethods {
	public static void main(String[] args) {
		 ...
		 */
		// GET MAX NUMBER
		System.out.println(productsList.stream().mapToDouble(o->o.getPrice()).summaryStatistics().getMax());
		
		//GET MIN NUMBER
		System.out.println(productsList.stream().mapToDouble(o->o.getPrice()).summaryStatistics().getMin());
	}
}
